    ...
    <footer className="footer-container">
      <div className="footer-content">
        <div className="footer-section about">
          ...
          <p>
            Explorando o universo através das cores e formas. Cada obra é uma janela para a alma.
          </p>
          <div className="contact">
            <span><i className="fas fa-phone"></i> &nbsp; [SEU TELEFONE]</span>
            <span><i className="fas fa-envelope"></i> &nbsp; [SEU EMAIL]</span>
          </div>
        </div>
        ...
        <div className="footer-section links">
          ...
          <ul>
            ...
            <li><a href="/sobre">Sobre a Artista</a></li>
